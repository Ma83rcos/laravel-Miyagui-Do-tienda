...
number_format($product['final_price'], 2) }}</span>
                ...
                <p class="text-sm text-orange-600 mt-2">
                    ¡Ahorra €{{ number_format($product['price'] -
...
number_format($product['price'], 2) }}</span>
            ...
            <div class="mb-6">
                ...
                <a href="{{ route('categories.show', $category['id']) }}" class="ml-2 bg-primary-100 text-primary-800 px-3 py-1
            ...
            <div class="mb-6">
                ...
                <div class="mt-2">
                    <span class="inline-block bg-orange-100 textorange-800 text-sm px-3 py-1 rounded-full">
                        🏷 {{ $product['offer']['name'] }} (-{{
