...
@if($product->offer)
<div class="absolute top-0 right-0 bg-gradient-to-r from-orange-500 tored-500 text-white px-4 py-2 rounded-bl-lg font-bold shadow-lg z-10">
<span class="text-lg">
...
class="bg-primary-600 text-white px-4 py-2 rounded-lg hover:bgprimary-700 transition">
Ver Detalles
</a>
</div>
</div>
